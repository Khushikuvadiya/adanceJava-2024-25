    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           Cookie [] ck=request.getCookies();
            ...
            out.println("<a href=page2 >Click here to visit page 2</a><br><br>");
            out.println("<a href=page3 >Click here to visit page 3</a><br><br>");
            out.println("<a href=page5 >Click here to visit page 5</a><br><br>");
